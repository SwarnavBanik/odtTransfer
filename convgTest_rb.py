"""
###############################################################################
Code for testing the convergence of thermodyrbmic properties of atoms in an ODT
###############################################################################
Created:    Swarrbv Banik  on  May 26, 2023 
"""
...
for ii in range(len(l_max)):
    ...
    odtPropScale = thermo.thermoODT( U, [x_temp,y_temp,z_temp], rb.m, \
