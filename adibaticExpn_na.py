...
Bdash_0       = 260        # Initial Field Gradient [G/cm]
Bdash_f       = 10         # Final Field Gradient [G/cm]
...
def U_total(bdash):
    ...
    U = U - np.min(U)
    return U
# Thermodynamic properties v/s Tscale =========================================
...
# %% Evaluate the initial and Final thermodynmic properties ###################
